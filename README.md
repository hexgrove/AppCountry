...
2. Install dependencies:
   ...
   dotnet restore
   ```
3. Configure your IPInfo token and MaxMind credentials in `appsettings.json` or use environment variables
...
GET /api/ip/status
```
Returns detailed information about both database statuses.
...
{
  "isAvailable": true,
  "message": "IPInfo: available (last modified: 2024-11-08T04:06:00); MaxMind: available (last modified: 2024-11-08T04:06:00)",
  "lastModified": "2024-11-08T04:06:00.000Z"
}
```
...
Manually triggers a database update for both data sources.
